...
ui_delayStart = lv_switch_create(ui_Screen1);
...
ui_delayStartLabel = lv_label_create(ui_Screen1);
...
ui_LightsOn = lv_switch_create(ui_Screen1);
...
ui_LightsLabel = lv_label_create(ui_Screen1);
